...
def partition_begin(array): # proper !
	global num_compares
	if len(array) <= 1:
		return array
	pivot = array[0]
	...
	array0 = partition_begin(array[0:i-1])
	array1 = partition_begin(array[i:])
	array0.append(array[i-1])
	return array0 + array1

def partition_final(array): # proper !
	global num_compares
	if len(array) <= 1:
		return array
	...
	array0 = partition_final(array[0:i-1])
	array1 = partition_final(array[i:])
	array0.append(array[i-1])
	return array0 + array1
	
def partition_middle(array): # proper !
	global num_compares
	if len(array) <= 1:
		return array
	...
	pivot_index = 0
	_, pivot_index = medean((array[0], 0), (array[middle_index], middle_index), (array[len(array)-1], len(array)-1))
	
	print("First:"+str(array[0])+" Middle: "+str(array[middle_index])+" Last: "+str(array[len(array)-1]))
	print("array[pivot_index]:"+str(array[pivot_index]))
	...
	array0 = partition_middle(array[0:i-1])
	array1 = partition_middle(array[i:])
	array0.append(array[i-1])
	return array0 + array1
